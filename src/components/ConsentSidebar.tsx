          ...
          <div className="p-6 space-y-6">
            ...
            <section className="space-y-3">
              ...
              <ul className="space-y-2 text-muted-foreground text-sm">
                ...
                <li className="flex gap-2">
                  <span>2.</span>
                  <span>Learn AI image generation basics through interactive slides (~15 minutes)</span>
                </li>
                <li className="flex gap-2">
                  <span>3.</span>
            ...
            <section className="space-y-3">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed text-justify">
                <strong className="text-foreground">Risks:</strong> Minimal. Some participants may experience mild fatigue during the approximately 15-minute session.
              </p>
              <p className="text-muted-foreground text-sm leading-relaxed text-justify">
